...
namespace ReviewsMicroservice.Service
{
    ...
    public class ReviewService
    {
        ...
        {
            this._context = AppDbContext.Create();
        }
        ...
        //Метод кој ажурира веќе постоечко Review од даден корисник за даден паркинг - ако нема соодветно Review не се прави ништо
